...
public class CategoryController {
    ...
    public ModelAndView saveOrUpdate(ModelMap model,
        ...
        Category entity = new Category(); // tao ra Entity
        BeanUtils.copyProperties(dto, entity); // copy du lieu tu dto sang entity

        categoryService.save(entity); // luu vao DB

        model.addAttribute("message", "Category is Seved!");
    ...
    public String list(ModelMap model) {
        ...
        return "admin/categories/pricing";
    }
